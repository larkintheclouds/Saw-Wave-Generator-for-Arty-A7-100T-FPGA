...
HD_PWD='C:/Users/acari/fpga_dev/osc_saw_440_hz/osc_saw_440_hz.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sawtooth_oscillator_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sawtooth_oscillator_top.tcl -notrace
