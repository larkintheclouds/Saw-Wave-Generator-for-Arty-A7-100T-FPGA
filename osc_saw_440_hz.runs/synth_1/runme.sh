...
HD_PWD='C:/Users/acari/fpga_dev/osc_saw_440_hz/osc_saw_440_hz.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sawtooth_oscillator_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sawtooth_oscillator_top.tcl
